...
public class User_UserInfo_servlet extends HttpServlet {
...
//        //User user=new User();
        ...
        String U_account=request.getParameter("data");
        String data1=new String(U_account.getBytes("ISO-8859-1"),"utf-8");//获取移动端传来的用户账号
...
//       String bString=encoder.encode(a);
        ...
        String string=impl.userSelfSearch(data1);   //调用一条数据（json）；
